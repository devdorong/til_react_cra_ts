      ...
      {isEdit ? (
        <div className="flex w-full items-center gap-2">
          <input
            ...
            className="flex-1 rounded-md border border-neutral-300 bg-white px-2 py-1 outline-none focus:ring-1 focus:ring-brand dark:border-neutral-700 dark:bg-neutral-900"
          />
          <button
